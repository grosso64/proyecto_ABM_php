...
<html lang="es">
  ...
  <body class="container">
    ...
    <div class="alert alert-primary" role="alert">
        <h3 class="text-center fst-italic">Eliminar usuario</h3>
    </div>
    <br>
                ...
                <div class="col-4">
                    ...
                    <form action="baja_usuario_sql.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly id="clave" name="clave" value="<?php echo $clave; ?>" class="form-control">
                        </div>
                        <br>
                        <div class="form-group">
                            <label for="rol">Perfil</label>
                            <input type="text" readonly id="rol" name="rol"  value="<?php echo $rol; ?>" class="form-control">
                        </div> 
                        <br>
                        <div class="row">
                            <div class="col-6">
                                <button type="submit" class="btn btn-primary container-fluid" name='boton' value=1>Eliminar</button>
                            </div>
                            <div class="col-6">
